        ...
        <div class="card-body">
            ...
            <form class="form-material" @submit.prevent="add">
                <div class="form-group form-float">
                    <div class="form-line">
                        <p class="p-label mb-0">Supplier</p>
                        <select class="form-control custom-select select2" id="supplier_id">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group form-float">
                            <div class="form-line">
                                <input type="text" class="form-control" name="invoice_no" v-model="purchase.invoice_no">
                ...
                <div class="form-group form-float">
                    <div class="form-line">
                        <textarea name="details" v-model="purchase.details" id="details"
                        ...
                        <div class="col-md-4">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <v-select label="name" :filterable="false" :options="productItems" @search="onSearch" v-model="purchase['products'][index].product_id">
                        ...
                        <div class="col-md-1">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <input type="number" :value="purchase['products'][index].product_id.stock" class="form-control" name="stock" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2">
                ...
                <button v-if="purchase['products'].length > 0 && submitted == false" class="btn btn-primary waves-effect" type="submit">
                    SUBMIT
                </button>
                <button v-else-if="purchase['products'].length > 0 && submitted == true"
                        class="btn btn-primary waves-effect" disabled>
    ...
    export default{
        ...
        methods: {
            add () {
                ...
                this.purchase.supplier_id = document.getElementById('supplier_id').value;
                this.purchase.purchase_date = document.getElementById('purchase_date').value;
                ...
                //sending request
                this.$axios.post('purchase', purchaseData, this.$auth.getHeader()).then(response => {

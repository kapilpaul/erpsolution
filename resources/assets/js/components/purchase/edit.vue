                        ...
                        <div class="col-md-4">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <select class="form-control" v-model="purchase['products'][index].pivot.product_id" @change="setProductStock(index)">
                        ...
                        <div class="col-md-1">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <input type="number" class="form-control" name="stock" disabled v-model="purchase['products'][index].stock">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2">
    ...
    export default{
        ...
        methods: {
            add () {
                ...
                //sending request
                this.$axios.patch('purchase/' + this.purchaseno, purchaseData, this.$auth.getHeader()).then(
                    response => {
                        this.$swal({
                            title: 'Success!',

            ...
            <form class="form-material" @submit.prevent="add">
                ...
                <div class="form-group form-float">
                    <div class="form-line">
                        ...
                        <textarea name="address" v-model="address" id="details" class="form-control"></textarea>
                ...
                <div class="form-group form-float">
                    <div class="form-line">
                        <input type="text" class="form-control" name="previous_purchase_amount" v-model="previous_purchase_amount">
                ...
                <div class="form-group form-float">
                    <div class="form-line">
                        <input type="text" class="form-control" name="balance" v-model="balance">
                ...
                <button  v-if="submitted == false" class="btn btn-primary waves-effect" type="submit">SUBMIT</button>

                <button v-else-if="submitted == true"
    ...
    export default{
        ...
        methods: {
            add () {
                ...
                this.$axios.post('customer', data,this.$auth.getHeader()).then(response => {

      ...
      <form class="form-material" @submit.prevent="add">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group form-float">
              <div class="form-line">
                <p class="p-label mb-0 edit-p-label">Destination</p>
                <input
                  type="text"
                  name="details"
            ...
            <div class="col-md-3">
              <div class="form-group form-float">
                <div class="form-line">
                  ...
                  <select
                    class="form-control"
                    v-model="invoice['products'][index].pivot.product_id"
              ...
              <div class="form-group form-float">
                <div class="form-line">
                  ...
                  <input
                    ...
                    name="stock"
                    disabled
                    v-model="invoice['products'][index].stock"
                  />
                </div>
              </div>
            </div>
...
export default {
    ...
    grandTotal() {
      ...
      if (typeof items != "undefined") {
        items.forEach(item => {
          ...
          grandtotal += Number(item.pivot.total);
        });
      }
  ...
  methods: {
    add() {
      ...
      //sending request
      this.$axios
        .patch("invoice/" + this.invoiceno, invoiceData, this.$auth.getHeader())
        .then(response => {
          this.$swal({
            title: "Success!",
    ...
    setProductStock(index) {
      ...
      this.$axios
        ...
        .then(response => {
          ...
          this.invoice["products"][index].pivot.price =
            response.data.product.sale_price;
        });
    }
  }
};

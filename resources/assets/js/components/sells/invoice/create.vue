  ...
  <div>
    <div class="card-body">
      ...
      <form class="form-material" @submit.prevent="add">
            ...
            <div class="col-md-1">
              <div class="form-group form-float">
                <div class="form-line">
                  ...
                  <input
                    type="number"
                    :value="invoice['products'][index].product_id.stock"
                    class="form-control"
                    name="stock"
                    disabled
                  />
        ...
        <div class="row">
          ...
          <div class="col-md-2">
            <input-text
              name="due"
              :showLabel="false"
              :value="grandTotal - invoice.paid_amount"
              :disabled="true"
            ></input-text>
          </div>
        ...
        <button
          class="btn btn-warning waves-effect float-left mr-10"
          @click.prevent="invoice.paid_amount = grandTotal"
        >Full Paid</button>
...
export default {
  ...
  methods: {
    add() {
      ...
      //sending request
      this.$axios
        .post("invoice", invoiceData, this.$auth.getHeader())
        .then(response => {
          this.invoice = {

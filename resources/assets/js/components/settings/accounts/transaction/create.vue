        ...
        <div class="card-body">
            ...
            <form class="form-material" @submit.prevent="add">
                    ...
                    <div class="col-md-7">
                        <div class="form-group form-float">
                            <div class="form-line">
                                ...
                                <v-select label="name" :options="receivers" v-model="itemData.receiver_id"></v-select>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <transition enter-active-class="animated fadeIn" leave-active-class="animated fadeOut">
                    <div v-if="itemData.tmode === 'cheque' || itemData.tmode === 'payorder'">
                        <div class="row">
                            <div class="col-md-6">
                                <input-text name="slip_id" label="Cheque/Payorder No *"
                                            v-model="chequeDetails.slip_id"></input-text>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        ...
                                        <input type="date" class="form-control" v-model="chequeDetails.date"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-float">
                            <div class="form-line">
                                ...
                                <v-select label="name" :options="banks" v-model="chequeDetails.bank_id"></v-select>
                            </div>
                        </div>

                        <input-radio name="permission_to_add_bank_transaction" label="Do you want to add this Transaction to your bank ?" :options="radioOptions" v-model="chequeDetails.add_bank_transaction"></input-radio>
                    </div>
                </transition>

                <input-text name="amount" label="Amount *" v-model="itemData.amount"></input-text>
                <input-text-area name="description" label="Description"
                                 v-model="itemData.description"></input-text-area>
    ...
    export default{
        ...
        methods: {
            add () {
                ...
                this.$axios.post('transactions', this.itemData, this.$auth.getHeader()).then(response => {
            ...
            getReceivers(value) {
                ...
                this.$axios.get(url, this.$auth.getHeader()).then(response => {
